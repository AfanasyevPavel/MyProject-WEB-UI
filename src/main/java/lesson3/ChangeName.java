...
public class ChangeName {
    public static void changeName() throws InterruptedException {
        ...
        WebElement webElement6 = webDriver.findElement(By.xpath("//*[@id=\"content\"]/div/a[1]"));
        webElement6.click();

        Thread.sleep(1000);

        WebElement webElement7 = webDriver.findElement(By.xpath("//*[@id=\"input-lastname\"]"));
        webElement7. clear();
        webElement7. sendKeys("Сидоров");

        Thread.sleep(1000);

        WebElement webElement8 = webDriver.findElement(By.xpath("//*[@id=\"content\"]/div/form/div/div[2]/input"));
        webElement8.click();
